...
Followng Wayne Stevens' original design, this parser supports a network name at the start, followed by a colon (see jpaulm/parsefbp#4).  If this is not provided, the generated JSON will generate a network name of `MyDiagram`.
